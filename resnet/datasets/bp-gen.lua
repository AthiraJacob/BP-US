...
--
--  Script to compute list of bp filenames and classes
--
--  This generates a file gen/bp.t7 which contains the list of all
--  bp training and validation images and their classes. This script also
...
local function findClasses(dir)
   ...
   -- assert(#classList == 2, 'expected 2 bp classes')
...
local function findImages(dir, classToIdx)
   ...
   local extensionList = {'jpg', 'png','JPG','PNG','JPEG', 'ppm', 'PPM', 'bmp', 'BMP','tif','TIF'}
